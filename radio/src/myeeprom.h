...
#if ROTARY_ENCODERS > 0
  SWSRC_FIRST_ROTARY_ENCODER,
  SWSRC_REA = SWSRC_FIRST_ROTARY_ENCODER,
#if ROTARY_ENCODERS > 1
  SWSRC_REB,
#endif
  SWSRC_LAST_ROTARY_ENCODER = SWSRC_FIRST_ROTARY_ENCODER+ROTARY_ENCODERS-1,
#endif
...
#if ROTARY_ENCODERS > 0
  SWSRC_FIRST_MOMENT_ROTARY_ENCODER_SWITCH,
  SWSRC_REA_SHORT = SWSRC_FIRST_MOMENT_ROTARY_ENCODER_SWITCH,
  SWSRC_REA_LONG,
#if ROTARY_ENCODERS > 1
  SWSRC_REB_SHORT,
  SWSRC_REB_LONG,
#endif
  SWSRC_LAST_MOMENT_ROTARY_ENCODER_SWITCH = SWSRC_FIRST_MOMENT_ROTARY_ENCODER_SWITCH+(2*ROTARY_ENCODERS)-1,
#endif
